...
Game::Game(ID3D11Device* _pd3dDevice, HWND _hWnd, HINSTANCE _hInstance) 
{
	...
	//Draw or Add Boids
	BoidsController* Boids = new BoidsController(200, Vector3(1, 1, 1), m_BoidData, _pd3dDevice, false);
	m_GameObjects.push_back(Boids);
	...
	BarControl = TwNewBar("Boid Tweaker");

	TwAddVarRW(BarControl, "MaxSpeed", TW_TYPE_FLOAT, &m_BoidData->MaxSpeed, "min = 0 max = 30 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "AlignmentMod", TW_TYPE_FLOAT, &m_BoidData->AlignmentMod, "min = 0 max = 10 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "NeighbourDistance", TW_TYPE_FLOAT, &m_BoidData->NeighbourDist, "min = 0 max = 80 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "CohesionDistance", TW_TYPE_FLOAT, &m_BoidData->NeighbourDistCoh, "min = 0 max = 100 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "CohesionMod", TW_TYPE_FLOAT, &m_BoidData->CohesionMod, "min = 0 max = 100 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "SepartionVal", TW_TYPE_FLOAT, &m_BoidData->SeparationVal, "min = 0 max = 10 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "SeperaionMod", TW_TYPE_FLOAT, &m_BoidData->SeperationMod, "min = 0 max = 100 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "EscapeDist", TW_TYPE_FLOAT, &m_BoidData->EscapeValue, "min = 0 max = 100 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "EscapeMod", TW_TYPE_FLOAT, &m_BoidData->EscapeMod, "min = 0 max = 10 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "PredatorSeekDist", TW_TYPE_FLOAT, &m_BoidData->PredatorSeekDist, "min = 0 max = 10 step= 0.01 group=Engine'");
	TwAddVarRW(BarControl, "PredatorSeekMod", TW_TYPE_FLOAT, &m_BoidData->PredatorSeekMod, "min = 0 max = 10 step= 0.01 group=Engine'");
