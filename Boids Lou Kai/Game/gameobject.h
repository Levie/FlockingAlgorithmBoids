...
public:
	...
	bool		GetisPredator() { return m_ispredator; }
	bool		GetisClosest() { return m_closest; }
	...
	void		SetPredator(bool pred) { m_ispredator = pred; }
	void		SetClosest(bool close) { m_closest = true; }
